export const livros = [
  {
    ...
    descricao: "Publicado em 1899, 'Dom Casmurro' é um dos maiores clássicos da literatura brasileira. Narrado em primeira pessoa por Bento Santiago, o romance é marcado pela dúvida e pela ambiguidade. Bentinho relembra sua juventude, seu amor por Capitu e o casamento marcado por suspeitas de traição, envolvendo seu melhor amigo, Escobar. A narrativa é permeada por ironia, introspecção e reflexões sobre memória, ciúme e confiança, deixando ao leitor a tarefa de decidir se Capitu foi ou não infiel. A obra é um retrato profundo da alma humana e de suas incertezas."
  },
  {
    id: "2",
    ...
    descricao: "Lançado em 1881, este romance inovador rompe com as convenções literárias da época ao ser narrado por um defunto-autor. Brás Cubas, após a morte, decide contar sua vida sem a preocupação de agradar ou omitir verdades incômodas. A narrativa mistura episódios de sua infância, amores frustrados e ambições fracassadas, sempre permeada por reflexões filosóficas e críticas à sociedade do século XIX. A obra apresenta humor ácido, pessimismo e uma visão desencantada do mundo, tornando-se um marco do realismo brasileiro e da literatura universal."
  },
  {
    id: "3",
    ...
    descricao: "Publicada em 1956, esta obra-prima da literatura brasileira traz a voz de Riobaldo, um ex-jagunço que narra sua vida no sertão de Minas Gerais. A narrativa, em fluxo contínuo e repleta de neologismos e regionalismos, mistura aventuras, batalhas, amores e pactos misteriosos. O eixo central é a relação com Diadorim, personagem cercado de segredos e ambiguidades. 'Grande Sertão: Veredas' é mais do que uma história de jagunços: é uma profunda reflexão sobre o bem e o mal, a condição humana e o sentido da existência."
  },
  {
    id: "4",
    titulo: "O Guarani",
